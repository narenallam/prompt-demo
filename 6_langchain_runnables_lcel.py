...
map_chain = RunnableMap(
    {"french": prompt1 | model | parser, "summary": prompt2 | model | parser}
)

result = map_chain.invoke(
    {"text": "LangChain 1.0 introduces Runnables and LCEL for composability."}
)
print(f"\nParallel Results:\n{result}")
...
prompt_stream = ChatPromptTemplate.from_template(
    "Write a 3-line haiku about composable AI."
)
