...
"""
    ...
    final_answer = synthesize_chain.invoke({
        "question": question,
        "all_branches": all_branches_text
    })
...
"""
    ...
    approach1 = approach_chain.invoke({"question": question, "style": "analytical and data-driven"})
    print(f"Analytical Approach:\n{approach1}\n")
    
    approach2 = approach_chain.invoke({"question": question, "style": "creative and innovative"})
    print(f"Creative Approach:\n{approach2}\n")
    
    approach3 = approach_chain.invoke({"question": question, "style": "practical and implementation-focused"})
