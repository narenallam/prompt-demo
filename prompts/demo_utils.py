...
def print_token_usage(response_obj: Any, start_time: Optional[float] = None, end_time: Optional[float] = None):
    """
    ...
    if 'timing' in metadata:
        ...
        first_token_time = timing.get('first_token_time') or timing.get('time_to_first_token')
        last_token_time = timing.get('last_token_time') or timing.get('time_to_last_token')
